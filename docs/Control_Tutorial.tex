...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, opacitybacktitle=0.6, opacityback=0, coltitle=black, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip with Title}, breakable, toprule=.15mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, bottomrule=.15mm]
